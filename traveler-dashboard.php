...
// Get user bookings
$bookings = [];
if (isset($_SESSION['user_id']) && function_exists('getUserBookings')) {
    try {
...
<section class="page-header" style="background-image: url('https://images.unsplash.com/photo-1550399504-8953e1a6ac87');">
    <div class="container">
        <div class="page-header-content">
            <h1 class="page-header-title">Traveler Dashboard</h1>
                                    ...
                                    <div class="booking-item">
                                        <div class="booking-header">
                                            <div class="booking-title">
                                                ...
                                                <div class="text-muted">Booking ID: <?php echo $booking['id']; ?></div>
                                            </div>
                                        ...
                                        <div class="booking-details">
                                            ...
                                            <div class="booking-detail">
                                                ...
                                                <p><?php echo formatDate($booking['travel_date']); ?></p>
                                            </div>
                                            <div class="booking-detail">
                                                <span>Travelers</span>
                                                <p><?php echo $booking['travelers']; ?> person(s)</p>
                                            </div>
                                            <div class="booking-detail">
                                                <span>Total Price</span>
                                                <p><?php echo formatCurrency($booking['total_price']); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="booking-actions">
                                            ...
                                            <?php if ($booking['status'] == 'pending' || $booking['status'] == 'confirmed'): ?>
                                                <a href="#" class="btn btn-sm btn-outline-danger cancel-booking-btn" data-id="<?php echo $booking['id']; ?>">
