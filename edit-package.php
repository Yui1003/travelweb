...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_package'])) {
    ...
    if (empty($title) || empty($description) || $price <= 0 || $duration <= 0) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: package-details.php?id=" . $packageId . "&created=1");
            exit;
        } else {
    ...
    <div class="container">
        <div class="dashboard-header" data-aos="fade-up">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="operator-dashboard.php">Dashboard</a></li>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="dashboard-card" data-aos="fade-up">
                    <div class="dashboard-card-header">
                        <h2><i class="fas fa-plus-circle me-2"></i>Create Package</h2>
                    </div>
                    <div class="dashboard-card-body">
                        <?php echo $message; ?>
                        
                        <form action="add-package.php" method="post" id="addPackageForm">
                            <div class="row mb-4">
                                <div class="col-md-8">
                                    <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="operator-dashboard.php" class="btn btn-outline-secondary">Cancel</a>
                                <button type="submit" name="add_package" class="btn btn-primary">Create Package</button>
                            </div>
                        </form>
                    </div>
                </div>
